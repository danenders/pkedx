...
extern const u8 gText_DefaultNameCaleb[];
extern const u8 gText_DefaultNameNoah[];
extern const u8 gText_DefaultNameDaniel[];
extern const u8 gText_DefaultNameJosh[];
extern const u8 gText_DefaultNameGeoff[];
extern const u8 gText_DefaultNameTyler[];
extern const u8 gText_DefaultNameMike[];
extern const u8 gText_DefaultNameChris[];
extern const u8 gText_DefaultNameStephen[];
extern const u8 gText_DefaultNameKevin[];
...
extern const u8 gText_DefaultNameRocco[];
extern const u8 gText_DefaultNameGarret[];
extern const u8 gText_DefaultNameDerrick[];
extern const u8 gText_DefaultNameShawn[];
