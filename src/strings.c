...
const u8 gText_CyndaquilDollAndPrice[] = _("CYNDAQUIL DOLL 1,000 COINS");
const u8 gText_ChikoritaDollAndPrice[] = _("CHIKORITA DOLL 1,000 COINS");
const u8 gText_TotodileDollAndPrice[]  = _("TOTODILE DOLL   1,000 COINS");
const u8 gText_VenusaurDollAndPrice[] = _("VENUSAUR DOLL   1,000 COINS");
const u8 gText_CharizardDollAndPrice[] = _("CHARIZARD DOLL 1,000 COINS");
const u8 gText_BlastoiseDollAndPrice[] = _("BLASTOISE DOLL 1,000 COINS");
