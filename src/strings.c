...
const u8 gText_TreeckoDollAndPrice[] = _("TREECKO DOLL 1000 COINS");
const u8 gText_TorchicDollAndPrice[] = _("TORCHIC DOLL 1000 COINS");
const u8 gText_MudkipDollAndPrice[]  = _("MUDKIP DOLL  1000 COINS");
const u8 gText_CyndaquilDollAndPrice[] = _("CYNDAQUIL DOLL 2000 COINS");
const u8 gText_ChikoritaDollAndPrice[] = _("CHIKORITA DOLL 2000 COINS");
const u8 gText_TotodileDollAndPrice[]  = _("TOTODILE DOLL  2000 COINS");
const u8 gText_VenusaurDollAndPrice[] = _("VENUSAUR DOLL   3000 COINS");
const u8 gText_CharizardDollAndPrice[] = _("CHARIZARD DOLL 3000 COINS");
const u8 gText_BlastoiseDollAndPrice[] = _("BLASTOISE DOLL 3000 COINS");
